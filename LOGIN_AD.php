        ...
        if ($user_data) {
            ...
            if ($clave_hasheada === $user_data['contrasena']) {
                ...
                if ($user_data['tipo'] === 'administrativo') {
                    header("Location: http://localhost/GYM/DASHBOARD/MIEMBROS.html");
                    exit;
                } else if ($user_data['tipo'] === 'venta') {
                    header("Location: http://localhost/GYM/DASHBOARD/VENTAS.html");
                    exit;
                } else {
...
<body>
    <img src="IMAGES/CARREÑO.png" alt="Agave decoration" class="agave-decoration agave-1 floating"
        style="animation-delay: 0s;" />
    <img src="IMAGES/ICO/AGAVE.ico" alt="Agave decoration" class="agave-decoration agave-2 floating"
    ...
    <div class="login-container">
        ...
        <div class="logo">
            ...
            <img src="IMAGES/GOKU.png" alt="Logo de la mezcalería" class="logo-img" />
        </div>
    ...
    <script src="JAVA/JAVA_LOGGIN.js"></script>
